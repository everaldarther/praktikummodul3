...
<body>
    <div class="container m-5">
        ...
        <h6 class="mt-4">Tugas Cloning Website Bootstrap</h6>
        <div class="list-group list-group mt-4">
            <a href="{{ url('/bootstrap') }}" class="list-group-item list-group-item-action">
                Clone Website Bootstrap (Tugas)
            </a>
        </div>

        <h6 class="mt-4">Latihan Praktikum Route</h6>
        <div class="list-group list-group-numbered mt-4">
            ...
            {{-- Regular Expresion --}}
            <a href="{{ url('/title/this-is-my_tittle') }}" class="list-group-item list-group-item-action">
            ...
            {{-- Fallback Route --}}
            <a href="{{ url('/fallbackcuy') }}" class="list-group-item list-group-item-action">
                Fallback Routes
            </a>
        </div>
